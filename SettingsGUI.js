...
function initializeAllSettings() {
    ...
    createSetting('DynamicSiphonologyMethod', ["Dynamic Siphonology Algorithm: Default", "Dynamic Siphonology Algorithm: Zfarm"], 'Defines which algorithm to use to calculate Dynamic Siphonology.<br><b>Default: </b>Use basic algorithm bundled with AutoTrimps<br><b>ZFarm: </b>Use zFarm logic to calculate target zone.', 'multitoggle', 1, null, 'Maps');
