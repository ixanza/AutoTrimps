...
function initializeAllSettings() {
    ...
    createSetting('DynamicSiphonologyMethod', ["Algorithm: Default", "Algorithm: Zfarm", "Algorithm: Extended"], 'Defines which algorithm to use to calculate Dynamic Siphonology.<br><b>Default: </b>Use basic algorithm bundled with AutoTrimps<br><b>ZFarm: </b>Use zFarm logic to calculate target zone.<br><b>Extended: </b>Uses more complex logic than default one. It should be less accurate than zFarm but much more faster', 'multitoggle', 0, null, 'Maps');
    ...
    createSetting('Sshighdmg', 'Spire Shield: High Damage', '<b>HIGH DAMAGE HEIRLOOM</b><br><br>Enter the name of your high damage heirloom. This is your heirloom that you will use during raiding. ', 'textValue', 'undefined', null, 'Spire');
    createSetting('Sslowdmg', 'Spire Shield: Low Damage', '<b>LOW DAMAGE HEIRLOOM</b><br><br>Enter the name of your low damage heirloom. This is the heirloom that you will use after spire. ', 'textValue', 'undefined', null, 'Spire');
    ...
    createSetting('Rhypostorage', 'Storage', 'Turn this on to disable buying sheds unless you need more wood for your HF: Bonfire target price. Essentially this means you wont get accidently bonfires but you may lose out on smithies and shield prestiges. ', 'boolean', 'false', null, 'Challenges');
    ...
    createSetting('forceWindF', 'Force Wind Formation', 'Forces wind formation if possible after defined zone is reached.<br>By default it is disabled. Put -1 to disable.', 'value', -1, null, 'Scryer');
    ...
    createSetting('hvalues', ['Heirloom Values: Rolling', 'Heirloom Values: Equal'], 'Decides Heirloom Values. <br><b>Rolling Values:</b> Heirloom values start from number of maximum modifiers and goes down for each modifier.<br><b>Equal Values:</b> Each mod has same value.', 'multitoggle', 0, null, 'Heirlooms');
...
function updateCustomButtons() {
    ...
    !radonon && getPageSetting("DynamicSiphonology") ? turnOn("DynamicSiphonologyMethod") : turnOff("DynamicSiphonologyMethod");
    ...
    radonon && getPageSetting('Rhypoon') == true ? turnOn("Rhypofarmzone") : turnOff("Rhypofarmzone");
    radonon && getPageSetting('Rhypoon') == true ? turnOn("Rhypofarmcell") : turnOff("Rhypofarmcell");
    radonon && getPageSetting('Rhypoon') == true ? turnOn("Rhypofarmstack") : turnOff("Rhypofarmstack");
    ...
    !radonon ? turnOn("forceWindF") : turnOff("forceWindF");
    ...
    (autoheirloomenable) ? turnOn('hvalues') : turnOff('hvalues');
