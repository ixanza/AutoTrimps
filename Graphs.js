...
function reloadGraph() {
    let selector = document.getElementById('graphSelection');
    if (selector) {
        let lastGraphValue = selector.value;
        setGraphData(lastGraphValue);
    }
}
