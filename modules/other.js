...
function buyWeps() {
	...
	preBuy(), game.global.buyAmt = Math.max(getPageSetting('gearamounttobuy'), 1), game.equipment.Dagger.level < mostEffectiveLevel("Dagger") && canAffordBuilding('Dagger', null, null, !0) && buyEquipment('Dagger', !0, !0), game.equipment.Mace.level < mostEffectiveLevel("Mace") && canAffordBuilding('Mace', null, null, !0) && buyEquipment('Mace', !0, !0), game.equipment.Polearm.level < mostEffectiveLevel("Polearm") && canAffordBuilding('Polearm', null, null, !0) && buyEquipment('Polearm', !0, !0), game.equipment.Battleaxe.level < mostEffectiveLevel("Battleaxe") && canAffordBuilding('Battleaxe', null, null, !0) && buyEquipment('Battleaxe', !0, !0), game.equipment.Greatsword.level < mostEffectiveLevel("Greatsword") && canAffordBuilding('Greatsword', null, null, !0) && buyEquipment('Greatsword', !0, !0), !game.equipment.Arbalest.locked && game.equipment.Arbalest.level < mostEffectiveLevel("Arbalest") && canAffordBuilding('Arbalest', null, null, !0) && buyEquipment('Arbalest', !0, !0), postBuy()
}

function buyArms() {
	if (!((getPageSetting('BuyArmorNew') == 1) || (getPageSetting('BuyArmorNew') == 3))) return;
	preBuy(), game.global.buyAmt = Math.max(getPageSetting('gearamounttobuy'), 1), game.equipment.Shield.level < mostEffectiveLevel("Shield", "Health") && canAffordBuilding('Shield', null, null, !0) && buyEquipment('Shield', !0, !0), game.equipment.Boots.level < mostEffectiveLevel("Boots", "Health") && canAffordBuilding('Boots', null, null, !0) && buyEquipment('Boots', !0, !0), game.equipment.Helmet.level < mostEffectiveLevel("Helmet", "Health") && canAffordBuilding('Helmet', null, null, !0) && buyEquipment('Helmet', !0, !0), game.equipment.Pants.level < mostEffectiveLevel("Pants", "Health") && canAffordBuilding('Pants', null, null, !0) && buyEquipment('Pants', !0, !0), game.equipment.Shoulderguards.level < mostEffectiveLevel("Shoulderguards", "Health") && canAffordBuilding('Shoulderguards', null, null, !0) && buyEquipment('Shoulderguards', !0, !0), game.equipment.Breastplate.level < mostEffectiveLevel("Breastplate", "Health") && canAffordBuilding('Breastplate', null, null, !0) && buyEquipment('Breastplate', !0, !0), !game.equipment.Gambeson.locked && game.equipment.Gambeson.level < mostEffectiveLevel("Gambeson", "Health") && canAffordBuilding('Gambeson', null, null, !0) && buyEquipment('Gambeson', !0, !0), postBuy()
}
...
const switchHeirloomsForSpire = () => {
	let spire = currentState.doingSpire;
...
const switchHeirloomsForRaiding = () => {
	let raidingMaps = currentState.raidingMaps;
